...
""" An application written in Python and Tkinter to calculate monthly mileage expenses. """
...
def mileage_returns():
    global app_status_update, total_miles
    global initial_start_miles
...
# Convert output csv file to Excel spreadsheet
